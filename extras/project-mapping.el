...
;; After starting Emacs to navigate the snarts repository, evaluate the code
;; below so that snarts' entrypoint, examples, and tests will be evaluated
;; correctly by lsp-mode and nimlangserver
